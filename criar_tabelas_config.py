            ...
            for aba in abas:
                ...
                if 'UECI' in aba.aba_name:
                    ...
                    if not DropdownConfig.query.filter_by(
                        ...
                        print("  ✓ 'Responsável pela Análise' criado")
                    ...
                    if not DropdownConfig.query.filter_by(
                        ...
                        db.session.add(dropdown)
                        print("  ✓ 'Unidade Gestora' criado")
                
                # Dropdowns para TODAS as planilhas
                ...
                if not DropdownConfig.query.filter_by(
                    ...
                    db.session.add(dropdown)
                    print("  ✓ 'STATUS DA RECOMENDAÇÃO' criado")
                ...
                if not DropdownConfig.query.filter_by(
                    ...
                    db.session.add(dropdown)
                    print("  ✓ 'Status para a UECI' criado")
...
if __name__ == '__main__':
    ...
    if sucesso:
        print("\n✓ Execute o servidor Flask com: py app.py")
    else:
